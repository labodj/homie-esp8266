...
| --------------------------------------------------------------------------- | -------------------------- | ------------------------------------------------------------------------------------------- | -------------------------- |
| Homie magic bytes                                                           | _None_                     | `0x25 0x48 0x4F 0x4D 0x49 0x45 0x5F 0x45 0x53 0x50 0x38 0x32 0x36 0x36 0x5F 0x46 0x57 0x25` | _None_                     |
...
[![GitHub logo](../assets/github.png) firmware_parser.py](https://github.com/labodj/homie-esp8266/blob/develop/scripts/firmware_parser/firmware_parser.py)
